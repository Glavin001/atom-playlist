...
module.exports =
  ...
  setupCommands: ->
    ...
    # Playlist
    workspace.command 'playlist:toggle-playlist', => @playlistView.toggle()
    # Search
    workspace.command 'playlist:toggle-search', => @searchView.toggle()
  ...
  activate: (state) ->
    ...
    @searchView = new SearchView(@trackProviders, @playlist)
